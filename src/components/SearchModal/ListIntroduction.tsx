      ...
      <PaddedColumn>
        <AutoColumn gap="14px">
          ...
          <Text style={{ marginBottom: '8px', textAlign: 'center' }}>
            SpaceSwap now supports token lists. You can add your own custom lists via IPFS, HTTPS and ENS.{' '}
          </Text>
          ...
          <OutlineCard style={{ marginBottom: '8px', padding: '1rem' }}>
            <Text fontWeight={400} fontSize={14} style={{ textAlign: 'center' }}>
              Token lists are an{' '}
              <ExternalLink href="https://github.com/SpaceFinance/default-token-list">open specification</ExternalLink>. Check out{' '}
